# -*- coding: utf-8 -*-
"""
想要实现streamlit share的线上引用，学习用
Created on 2022年4月3日 11:33:54
@author: 学习者KarlQu
"""
...
if st.button('点击进行评价'):
    ...
    st.write(' 基于随机森林分类器 Based on feature values, your wine quality is '+ str(prediction))